...
<template>
  <div class="BookDetails-contaniner">
    ...
    <div class="BookDetails-main" ref="bookdetails" @scroll="gundong">
      <div class="BookDetails-main-top">
        ...
        <div class="BookDetails-main-top-right">
          ...
          <div class="right-four margin-left">
            <span>5春卷/千字</span>
            <span class="four-padding">{{ value.wordcount + "万字" }}</span>
          </div>
        </div>
      </div>
      <div class="BookDetails-main-bottom">
        <span class="bottom-span geshi" ref="wanwan"
          >{{ chulichange }}
      ...
      <!-- 子组件，推荐书区域  -->
      <introduce-book
        @close="handleAllChange($event)"
        :kongzhidianji="kongzhidianji"
      ></introduce-book>
      <div class="kongzhibai"></div>
      <author-other
        :dianji="dianji"
        @close="handleChange($event)"
      ></author-other>
      <div class="kongzhibai"></div>
      <div class="BookInformation">
        <span class="span-one"> 书籍信息 </span>
    ...
    <div class="BookDetails-footer" active-color="#fff">
      ...
      <div class="footer-item red" @click="readClick">免费试读</div>
      <div class="footer-item felx" @click="addRack">加入书架</div>
    </div>
  </div>
</template>
